...
$(function  () {
	...
	var le=$('#content li').length;
		$('html,body').mousewheel(function(event, delta, deltaX, deltaY){
			...
			//翻页事件page4	
			.scroll(function  () {
					if (siz>hi*2+30&&siz<hi*3+30) {$(".page4_bg").addClass("animated bounceInUp").show()}	
						else {
                     if (siz!=hi*3) {$(".page4_bg").removeClass("animated bounceInUp").fadeOut(500)}
						     }
						             })	
			//翻页事件page4	
			.scroll(function  () {
					if (siz>hi*2+30&&siz<hi*3+30) {$(".page1_yun1").css("position","absolute")}	
					else {
                     if (siz!=hi*3) {$(".page1_yun1").css("position","fixed")}
						     }})
			.scroll(function  () {
					if (siz>hi*2+30&&siz<hi*3+30) {$(".page1_yun2	").css("position","absolute")}
					else {
                     if (siz!=hi*3) {$(".page1_yun2").css("position","fixed")}
						     }})	
			.scroll(function  () {
					if (siz>hi*2+30&&siz<hi*3+30) {$(".page1_yun3").css("position","absolute")}	
					else {
                     if (siz!=hi*3) {$(".page1_yun3").css("position","fixed")}
						     }})	
							 
			//翻页事件page5	
			.scroll(function  () {
					if (siz>hi*3+30&&siz<hi*4+30) {$(".page5_bg").addClass("animated bounceInUp").show()}	
						else {
                     if (siz!=hi*4) {$(".page5_bg").removeClass("animated bounceInUp").fadeOut(500)}
						     }
						             })					 			 			 
})